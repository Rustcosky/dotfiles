...
*** LaTeX
[[https://emacsdocs.org/docs/auctex/AUCTeX][AUCTeX]]
   #+begin_src emacs-lisp
...
** AI-Integration
There are many integrations for AI-assistance out there. The community (including me) generally seems to like [[https://github.com/editor-code-assistant/eca-emacs][ECA]] for a provider-agnostic framework.
...
Using Ollama as a provider requires a little bit of configuration. Here is an example to be put in ~/.config/eca/config.json.

#+begin_src json :tangle no
{
  "$schema": "https://eca.dev/config.json",

  "defaultModel": "ollama-openai/gemma4:26b",
  ...
  "providers": {
	...
	"hf.co/groxaxo/Huihui-gemma-4-26B-A4B-it-abliterated-GGUF:UD-Q4_K_M": {
          "limit": {
            "context": 262144,
            "output": 8192
          },
